...
- If the file doesn't exist and this is a `new` sprint: use `ask_question`:
...
3. Ask the user what to change: stories to add, remove, reprioritize, or re-estimate. Use `ask_question` to gather changes.
