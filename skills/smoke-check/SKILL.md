...
user-invocable: true
allowed-tools: view_file, find_by_name, grep_search, run_command, write_to_file, ask_question
model: inherit
---
...
Use `ask_question` to batch-verify. Keep to at most 3 calls.
...
- Use `ask_question` for all manual smoke check verification.
