...
user-invocable: true
allowed-tools: view_file, find_by_name, grep_search, write_to_file, run_command, invoke_subagent, ask_question
model: inherit
---
...
If they differ, use `ask_question` before proceeding:
